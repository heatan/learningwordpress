...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/dist/css/stylesheet.css" type="text/css">
...
<div class="site-title-wrap">
    ...
    <a href="<?php echo home_url(); ?>">
        <img class="title-img" src="<?php echo get_template_directory_uri() ?>/images/brand.png" alt="">
    </a>
